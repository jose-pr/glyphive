...
fine-tuned for **Nimbus Mono PS** renderings of the base16c alphabet.
...
- **Training corpus:** synthetic — randomly generated base16c-alphabet lines
  rendered to images. Trained via Nimbus Mono PS (URW), the metric-compatible clone of the PostScript core font 'Courier' that FPDF renders; distributed by URW under the AFPL/URW font license. Only synthetic renders were used for training; no font file ships in this wheel.
