"""The ``tesseract-glyphive-dejavu`` OCR provider (fine-tuned model).
...
class DejaVuGlyphiveProvider(OcrProvider):
    """Tesseract constrained to the base16g alphabet, using the DejaVu model."""

    name = "tesseract-glyphive-dejavu"
