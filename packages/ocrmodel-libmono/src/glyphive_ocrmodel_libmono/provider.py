"""The ``tesseract-glyphive-libmono`` OCR provider (fine-tuned model).
...
class LibmonoGlyphiveProvider(OcrProvider):
    """Tesseract constrained to the base16g alphabet, using the libmono model."""

    name = "tesseract-glyphive-libmono"
