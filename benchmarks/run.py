...
* ``g1`` encode/decode for fixed 1 KiB and 16 KiB payloads.
...
import glyphive
from glyphive.codec.g1 import G1Codec
...
INNER_COUNTS = {
    "codec.g1.encode_1k": 10,
    "codec.g1.decode_1k": 10,
    "codec.g1.encode_16k": 2,
    "codec.g1.decode_16k": 2,
...
def measure() -> ty.Dict[str, ty.Dict[str, float]]:
    ...
    if codec.decode(small_lines) != small or codec.decode(medium_lines) != medium:
        raise RuntimeError("benchmark fixture failed the g1 round-trip check")
    ...
    workloads = {
        "codec.g1.encode_1k": lambda: codec.encode(
            small, line_width=LINE_WIDTH, parity_ratio=PARITY_RATIO
        ),
        "codec.g1.decode_1k": lambda: codec.decode(small_lines),
        "codec.g1.encode_16k": lambda: codec.encode(
            medium, line_width=LINE_WIDTH, parity_ratio=PARITY_RATIO
        ),
        "codec.g1.decode_16k": lambda: codec.decode(medium_lines),
...
def build_result(
    ...
    return {
        ...
        "workloads": {
            ...
            "layout": {
                "input": "precomputed g1 16k lines",
